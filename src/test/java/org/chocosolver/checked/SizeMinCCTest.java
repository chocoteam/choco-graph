...
import org.chocosolver.GraphFactory;
...
public class SizeMinCCTest {
    ...
    private class AbstractTestModel {
        ...
        public AbstractTestModel(int N, int minNCC_LB, int minNCC_UB,
            ...
            this.GLB = GraphFactory.makeUndirectedGraph(
                    model,
                    N,
            ...
            this.GUB = GraphFactory.makeUndirectedGraph(
                    model,
                    N,
                    SetType.BIPARTITESET,
                    GUB_Nodes,
    ...
    public void batchTest() {
        ...
        for (int k : IntStream.range(0, 1).toArray()) {
            ...
            UndirectedGraph GLB = GraphFactory.makeRandomUndirectedGraphFromNbCC(model, N, SetType.BITSET, nbCC1, 0.3, 10);
            UndirectedGraph GUB = GraphFactory.makeRandomUndirectedGraphFromNbCC(model, N, SetType.BITSET, nbCC2, 0.1, 5);
